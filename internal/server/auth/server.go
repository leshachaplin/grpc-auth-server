...
func (s *Server) AddClaims(ctx context.Context, req *protocol.AddClaimsRequest) (*protocol.AuthEmptyResponse, error) {
	err := s.Rpc.AddClaims(req.Claims, ctx, req.Login)
	if err != nil {
		log.Errorf("erron in adding claims: %s", err)
		return nil, err
	}
	return &protocol.AuthEmptyResponse{}, nil
}

func (s *Server) DeleteClaims(ctx context.Context ,req *protocol.DeleteClaimsRequest) (*protocol.AuthEmptyResponse, error) {
...
func (s *Server) SignUp(ctx context.Context, req *protocol.SignUpRequest) (*protocol.AuthEmptyResponse, error) {
...
func (s *Server) Confirm(ctx context.Context, req *protocol.ConfirmRequest) (*protocol.AuthEmptyResponse, error) {
...
func (s *Server) Restore(ctx context.Context, req *protocol.RestoreRequest) (*protocol.AuthEmptyResponse, error) {
	...
	return &protocol.AuthEmptyResponse{}, err
}

func (s *Server) ChangePassword(ctx context.Context, req *protocol.ChangePasswordRequest) (*protocol.AuthEmptyResponse, error) {
...
func (s *Server) ForgotPassword(ctx context.Context, req *protocol.ForgotPasswordRequest) (*protocol.AuthEmptyResponse, error) {
